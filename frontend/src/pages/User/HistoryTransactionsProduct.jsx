...
const HistoryTransactionsProduct = () => {
  const { id } = useParams();
  ...
  const getOrder = async () => {
    try {
      const url = `${import.meta.env.VITE_API_BASE_URL}/api/product-transactions/user/${userId}`;
...
export default HistoryTransactionsProduct;
